...
import codelabs.m.appfoodscontact.utils.MethodUtils
import codelabs.m.appfoodscontact.utils.MethodUtils.Companion.replaceFragmentSafely
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            ...
            R.id.nav_food -> {
                ...
                val TAG_FRAGMENT_TWO:String="Deuxieme"

                replaceFragmentSafely(
                    fragment = ListSqliteTraiteurFragment(),
